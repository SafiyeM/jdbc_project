...
VALUES (5,'Severus','Snape','Tester',130000);

INSERT INTO SCRUMTEAM(emp_id, first_name, last_name, job_title, salary)
VALUES (6,'Harold','Finch','Developer',140000);

INSERT INTO SCRUMTEAM(emp_id, first_name, last_name, job_title, salary)
VALUES (7,'Phoebe','Buffay','Scrum Master',90000);

INSERT INTO SCRUMTEAM(emp_id, first_name, last_name, job_title, salary)
VALUES (8,'Michael','Scofield','PO',150000);
...
TRUNCATE TABLE SCRUMTEAM_;

select * from SCRUMTEAM_;

DROP TABLE SCRUMTEAM_;
